---
title: 'CodeIgniter4: Konfigurasi Awal dan Pola Desain MVC'
date: 2026-03-20
permalink: /posts/2026-03-20-konfigurasi-awal-dan-mvc/
header:
  teaser: "posts/ci4/pawf3a.png"
description: "Konfigurasi awal, command line, migration-seeder, database, routing, library-helper, dan pola MVC."
tags:
  - CodeIgniter4
  - MVC
  - Migration
...
Framework CodeIgniter menyediakan kerangka dasar yang kuat dan fleksibel untuk pengembangan aplikasi web berbasis PHP. Pada artikel ini, kita mempelajari konfigurasi awal project CI4, penggunaan command line, migration dan seeder, pengaturan database, routing, pemanfaatan library-helper, serta implementasi pola MVC (Model-View-Controller).
...
Lalu akses dari controller, contoh letakkan kode berikut di app/Controllers/Home.php:
...
Selanjutnya muat ulang halaman home (localhost:8080) untuk melihat perubahan!

![Home MySite](/images/posts/ci4/pawf3.png "Home MySite")
...
```
![View Task](/images/posts/ci4/pawf3a.png "View Task")
