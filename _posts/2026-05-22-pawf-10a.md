...
- Setup proyek baru pada folder `django/project3`.
...
## 1. Konsep Utama Chapter 3

Chapter ini menekankan tiga fondasi penting pengembangan web dengan Django:
...
## 2. Setup Awal Proyek pada `django/project3`
...
```html
{% comment %}Komentar ini tidak akan tampil di browser{% endcomment %}
```
