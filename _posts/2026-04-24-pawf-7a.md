...
![Registrasi MythAuth](/images/posts/ci4/pawf7x.png "Registrasi MythAuth")
...
![Login MythAuth](/images/posts/ci4/pawf7.png "Login MythAuth")
...
4. Bug form registrasi: ![Error Reg MythAuth](/images/posts/ci4/pawf7y.png "Error Reg MythAuth")

	`ValidatorInterface.php` di beberapa kombinasi versi CI4 + Myth/Auth terdapat error saat registrasi. Disarankan untuk edit file pada: `vendor/myth/auth/src/Authentication/Passwords/ValidatorInterface.php`
...
Lalu ubah juga bagian navbar pada frontend, misalnya `app/Views/layouts/navbar.php` menjadi:
```php
