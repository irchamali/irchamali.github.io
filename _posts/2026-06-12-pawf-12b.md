...
header:
  teaser: "posts/django/04_homepage.png"
...
The original reference chapter used Django 5.x syntax for package installation. In this note, the implementation is aligned with Django 6 to stay consistent with the previous PAWF chapter series.
...
After saving, Django redirects you to the posts list page. Initially, entries appear with labels like `Post object (1)` because we have not customized the string representation yet.
...
Expected outcome: all tests pass and Django creates/destroys a temporary test database automatically.
